# Ref: https://appliedmachinelearning.wordpress.com/2017/02/12/sentiment-analysis-using-tf-idf-weighting-pythonscikit-learn/
...
root_dir = 'D:/Education/DataScience/NLP/txt_sentoken'
